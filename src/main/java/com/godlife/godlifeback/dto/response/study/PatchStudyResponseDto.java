...
public class PatchStudyResponseDto extends ResponseDto {
    ...
    private PatchStudyResponseDto(String code, String message) {
        super(code, message);
    }

    public static ResponseEntity<PatchStudyResponseDto> success() {
        PatchStudyResponseDto result = new PatchStudyResponseDto(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
